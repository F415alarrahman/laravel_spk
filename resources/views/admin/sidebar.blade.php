            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('manajemen_field') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap ml-4">Manajemen Lapangan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('manajemen_user') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap ml-4">Manajemen User</span>
                    </a>
                </li>
                <div class="bottom-center flex items-center space-x-4">
                    @if (Auth::user())
